...
\begin{center}
$\vcenter{\hbox{\includegraphics[height=1.5in]{reply_screenshot.png}}} \rightarrow 1 \hspace{1em} \vcenter{\hbox{\includegraphics[height=1.5in]{no_reply.png}}} \rightarrow 0$
\end{center}
